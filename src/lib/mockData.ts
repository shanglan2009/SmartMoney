...
export const stockList: StockListItem[] = [
  // ─── 芯片/半导体 ───
  { code: "688981", name: "中芯国际", industry: "芯片制造", score: 82, rating: "减持" as RatingLevel, priceChange: "+12.3%", signal: "供应链紧张，国产替代加速", lastUpdated: "2026-05-30 12:00" },
  { code: "002371", name: "北方华创", industry: "芯片设备", score: 65, rating: "持有" as RatingLevel, priceChange: "+8.5%", signal: "设备供应链稳定，国产化率提升", lastUpdated: "2026-05-30 12:00" },
  { code: "688041", name: "海光信息", industry: "芯片设计", score: 88, rating: "减持" as RatingLevel, priceChange: "+15.2%", signal: "先进制程产能受限，单一供应商依赖", lastUpdated: "2026-05-30 12:00" },
  { code: "688256", name: "寒武纪", industry: "AI芯片", score: 91, rating: "减持" as RatingLevel, priceChange: "+22.1%", signal: "算力芯片需求暴增，供应严重不足", lastUpdated: "2026-05-30 12:00" },
  { code: "300661", name: "圣邦股份", industry: "模拟芯片", score: 45, rating: "增持" as RatingLevel, priceChange: "-2.1%", signal: "多元供应商体系，替代选择充足", lastUpdated: "2026-05-30 12:00" },
  { code: "603986", name: "兆易创新", industry: "存储芯片", score: 62, rating: "持有" as RatingLevel, priceChange: "+5.3%", signal: "NOR Flash供需平衡，国产替代推进", lastUpdated: "2026-05-30 12:00" },
  { code: "688008", name: "澜起科技", industry: "芯片/内存接口", score: 75, rating: "减持" as RatingLevel, priceChange: "+8.2%", signal: "EDA工具依赖进口", lastUpdated: "2026-05-30 12:00" },
  { code: "688037", name: "芯源微", industry: "芯片设备", score: 68, rating: "持有" as RatingLevel, priceChange: "-2.5%", signal: "国产替代加速中", lastUpdated: "2026-05-30 12:00" },
  { code: "688099", name: "晶晨股份", industry: "AI芯片", score: 65, rating: "持有" as RatingLevel, priceChange: "+1.5%", signal: "上游芯片供应紧张", lastUpdated: "2026-05-30 12:00" },
  { code: "688200", name: "华峰测控", industry: "芯片测试", score: 55, rating: "持有" as RatingLevel, priceChange: "+1.5%", signal: "EDA工具依赖进口", lastUpdated: "2026-05-30 12:00" },
  { code: "688627", name: "精智达", industry: "芯片测试设备", score: 60, rating: "持有" as RatingLevel, priceChange: "+12.5%", signal: "国产替代加速中", lastUpdated: "2026-05-30 12:00" },
  { code: "688652", name: "京仪装备", industry: "半导体设备", score: 55, rating: "持有" as RatingLevel, priceChange: "+5.8%", signal: "供应链状态正常", lastUpdated: "2026-05-30 12:00" },
  // ─── AI/算力 ───
  { code: "300308", name: "中际旭创", industry: "光模块/算力", score: 78, rating: "减持" as RatingLevel, priceChange: "+35.6%", signal: "AI算力需求爆发，上游光芯片供应紧张", lastUpdated: "2026-05-30 12:00" },
  { code: "300502", name: "新易盛", industry: "光模块", score: 72, rating: "减持" as RatingLevel, priceChange: "+28.4%", signal: "高速率光芯片依赖进口", lastUpdated: "2026-05-30 12:00" },
  { code: "000977", name: "浪潮信息", industry: "AI服务器/算力", score: 68, rating: "减持" as RatingLevel, priceChange: "+18.5%", signal: "GPU供应受限但需求旺盛", lastUpdated: "2026-05-30 12:00" },
  { code: "603019", name: "中科曙光", industry: "算力/超算", score: 60, rating: "持有" as RatingLevel, priceChange: "+9.2%", signal: "国产算力芯片替代方案在推进", lastUpdated: "2026-05-30 12:00" },
  { code: "002230", name: "科大讯飞", industry: "AI应用", score: 35, rating: "增持" as RatingLevel, priceChange: "+5.8%", signal: "供应链健康，算力资源有保障", lastUpdated: "2026-05-30 12:00" },
  { code: "002065", name: "东华软件", industry: "AI/算力", score: 45, rating: "持有" as RatingLevel, priceChange: "-0.8%", signal: "上游芯片供应紧张", lastUpdated: "2026-05-30 12:00" },
  { code: "001339", name: "智微智能", industry: "AI/算力", score: 58, rating: "持有" as RatingLevel, priceChange: "+4.1%", signal: "上游芯片供应紧张", lastUpdated: "2026-05-30 12:00" },
  { code: "000988", name: "华工科技", industry: "AI/光模块", score: 72, rating: "减持" as RatingLevel, priceChange: "-5.2%", signal: "上游芯片供应紧张", lastUpdated: "2026-05-30 12:00" },
  { code: "000725", name: "京东方A", industry: "AI/面板", score: 62, rating: "持有" as RatingLevel, priceChange: "-3.8%", signal: "上游芯片供应紧张", lastUpdated: "2026-05-30 12:00" },
  { code: "300476", name: "胜宏科技", industry: "PCB/AI", score: 60, rating: "持有" as RatingLevel, priceChange: "+1.5%", signal: "算力需求持续增长", lastUpdated: "2026-05-30 12:00" },
  { code: "300548", name: "长芯博创", industry: "光模块", score: 65, rating: "持有" as RatingLevel, priceChange: "-0.8%", signal: "供应链状态正常", lastUpdated: "2026-05-30 12:00" },
  { code: "002236", name: "大华股份", industry: "AI应用", score: 35, rating: "增持" as RatingLevel, priceChange: "-5.2%", signal: "供应链国产替代推进", lastUpdated: "2026-05-30 12:00" },
  { code: "300088", name: "长信科技", industry: "AI应用", score: 38, rating: "增持" as RatingLevel, priceChange: "+5.8%", signal: "上游芯片供应紧张", lastUpdated: "2026-05-30 12:00" },
  { code: "300231", name: "银信科技", industry: "AI应用", score: 35, rating: "增持" as RatingLevel, priceChange: "+8.2%", signal: "上游芯片供应紧张", lastUpdated: "2026-05-30 12:00" },
  // ─── 储能/锂电池 ───
  { code: "300750", name: "宁德时代", industry: "储能/锂电池", score: 58, rating: "持有" as RatingLevel, priceChange: "+3.2%", signal: "锂矿价格波动，供应商多元化布局", lastUpdated: "2026-05-30 12:00" },
  { code: "300274", name: "阳光电源", industry: "储能/逆变器", score: 48, rating: "持有" as RatingLevel, priceChange: "+6.7%", signal: "IGBT供应改善，元器件替代方案成熟", lastUpdated: "2026-05-30 12:00" },
  { code: "002074", name: "国轩高科", industry: "储能/锂电池", score: 63, rating: "持有" as RatingLevel, priceChange: "-1.5%", signal: "正极材料依赖单一供应商", lastUpdated: "2026-05-30 12:00" },
  { code: "002015", name: "协鑫能科", industry: "储能/算力", score: 52, rating: "持有" as RatingLevel, priceChange: "+5.8%", signal: "锂电材料价格波动", lastUpdated: "2026-05-30 12:00" },
  { code: "002850", name: "科达利", industry: "储能", score: 55, rating: "持有" as RatingLevel, priceChange: "+1.5%", signal: "IGBT供应改善", lastUpdated: "2026-05-30 12:00" },
  { code: "301358", name: "湖南裕能", industry: "储能/正极材料", score: 62, rating: "持有" as RatingLevel, priceChange: "+8.2%", signal: "锂电材料价格波动", lastUpdated: "2026-05-30 12:00" },
  { code: "300953", name: "震裕科技", industry: "储能", score: 50, rating: "持有" as RatingLevel, priceChange: "-2.5%", signal: "产能扩张中", lastUpdated: "2026-05-30 12:00" },
  { code: "688472", name: "阿特斯", industry: "储能/光伏", score: 50, rating: "持有" as RatingLevel, priceChange: "+3.5%", signal: "产能扩张中", lastUpdated: "2026-05-30 12:00" },
  // ─── 电力 ───
  { code: "600900", name: "长江电力", industry: "电力", score: 18, rating: "强烈推荐" as RatingLevel, priceChange: "+2.1%", signal: "供应链极简，无重大上游依赖", lastUpdated: "2026-05-30 12:00" },
  { code: "601985", name: "中国核电", industry: "电力/核电", score: 35, rating: "增持" as RatingLevel, priceChange: "+4.2%", signal: "核燃料供应链稳定，国产化率高", lastUpdated: "2026-05-30 12:00" },
  { code: "600406", name: "国电南瑞", industry: "电力设备/智能电网", score: 42, rating: "增持" as RatingLevel, priceChange: "+3.8%", signal: "电力IT供应链自主可控", lastUpdated: "2026-05-30 12:00" },
  { code: "600674", name: "川投能源", industry: "电力", score: 22, rating: "增持" as RatingLevel, priceChange: "+3.5%", signal: "来水预期改善", lastUpdated: "2026-05-30 12:00" },
  { code: "600163", name: "中闽能源", industry: "电力", score: 32, rating: "增持" as RatingLevel, priceChange: "+12.5%", signal: "来水预期改善", lastUpdated: "2026-05-30 12:00" },
  { code: "000690", name: "宝新能源", industry: "电力", score: 48, rating: "持有" as RatingLevel, priceChange: "+2.3%", signal: "来水预期改善", lastUpdated: "2026-05-30 12:00" },
  { code: "001286", name: "陕西能源", industry: "电力", score: 35, rating: "增持" as RatingLevel, priceChange: "+12.5%", signal: "来水预期改善", lastUpdated: "2026-05-30 12:00" },
  { code: "000600", name: "建投能源", industry: "电力", score: 55, rating: "持有" as RatingLevel, priceChange: "+12.5%", signal: "供应链稳定，运营平稳", lastUpdated: "2026-05-30 12:00" },
  { code: "600930", name: "华电新能", industry: "电力", score: 28, rating: "增持" as RatingLevel, priceChange: "+5.8%", signal: "供应链稳定，运营平稳", lastUpdated: "2026-05-30 12:00" },
  { code: "001376", name: "百通能源", industry: "电力", score: 30, rating: "增持" as RatingLevel, priceChange: "-0.8%", signal: "燃料成本可控", lastUpdated: "2026-05-30 12:00" },
  { code: "001896", name: "豫能控股", industry: "电力/算力", score: 55, rating: "持有" as RatingLevel, priceChange: "+2.3%", signal: "供应链稳定，运营平稳", lastUpdated: "2026-05-30 12:00" },
  { code: "601669", name: "中国电建", industry: "电力工程/储能", score: 42, rating: "持有" as RatingLevel, priceChange: "+12.5%", signal: "供应链稳定，运营平稳", lastUpdated: "2026-05-30 12:00" },
  { code: "601868", name: "中国能建", industry: "电力工程/储能", score: 38, rating: "增持" as RatingLevel, priceChange: "-3.8%", signal: "供应链稳定，运营平稳", lastUpdated: "2026-05-30 12:00" },
  { code: "600089", name: "特变电工", industry: "电力设备/储能", score: 48, rating: "持有" as RatingLevel, priceChange: "+4.1%", signal: "燃料成本可控", lastUpdated: "2026-05-30 12:00" },
  { code: "002364", name: "中恒电气", industry: "电力设备", score: 45, rating: "持有" as RatingLevel, priceChange: "+4.1%", signal: "燃料成本可控", lastUpdated: "2026-05-30 12:00" },
  // ─── 高端制造/机器人 ───
  { code: "002594", name: "比亚迪", industry: "新能源车/高端制造", score: 42, rating: "增持" as RatingLevel, priceChange: "+2.8%", signal: "垂直整合供应链，核心部件自供", lastUpdated: "2026-05-30 12:00" },
  { code: "300124", name: "汇川技术", industry: "机器人/工控", score: 52, rating: "持有" as RatingLevel, priceChange: "+4.5%", signal: "核心芯片供应有替代方案", lastUpdated: "2026-05-30 12:00" },
  { code: "688169", name: "石头科技", industry: "机器人/扫地机", score: 28, rating: "强烈推荐" as RatingLevel, priceChange: "+1.2%", signal: "供应链管理优秀，供应商竞争充分", lastUpdated: "2026-05-30 12:00" },
  { code: "601727", name: "上海电气", industry: "高端制造/电力设备", score: 60, rating: "持有" as RatingLevel, priceChange: "+1.8%", signal: "关键零部件进口依赖度高", lastUpdated: "2026-05-30 12:00" },
  { code: "601138", name: "工业富联", industry: "高端制造/AI服务器", score: 55, rating: "持有" as RatingLevel, priceChange: "+10.3%", signal: "AI服务器需求旺盛，GPU供应受限", lastUpdated: "2026-05-30 12:00" },
  { code: "002384", name: "东山精密", industry: "PCB/高端制造", score: 65, rating: "持有" as RatingLevel, priceChange: "+3.5%", signal: "精密部件进口可控", lastUpdated: "2026-05-30 12:00" },
  { code: "002527", name: "新时达", industry: "机器人", score: 52, rating: "持有" as RatingLevel, priceChange: "+2.3%", signal: "核心零部件国产化", lastUpdated: "2026-05-30 12:00" },
  { code: "002520", name: "日发精机", industry: "高端制造", score: 50, rating: "持有" as RatingLevel, priceChange: "-0.8%", signal: "精密部件进口可控", lastUpdated: "2026-05-30 12:00" },
  { code: "002048", name: "宁波华翔", industry: "高端制造", score: 38, rating: "增持" as RatingLevel, priceChange: "+3.5%", signal: "自主供应链完善", lastUpdated: "2026-05-30 12:00" },
  { code: "002815", name: "崇达技术", industry: "高端制造", score: 42, rating: "持有" as RatingLevel, priceChange: "-5.2%", signal: "精密部件进口可控", lastUpdated: "2026-05-30 12:00" },
  { code: "000837", name: "秦川机床", industry: "高端制造/机床", score: 48, rating: "持有" as RatingLevel, priceChange: "+3.5%", signal: "原材料价格稳定", lastUpdated: "2026-05-30 12:00" },
  { code: "002126", name: "银轮股份", industry: "高端制造", score: 42, rating: "持有" as RatingLevel, priceChange: "+4.1%", signal: "原材料价格稳定", lastUpdated: "2026-05-30 12:00" },
  { code: "600673", name: "东阳光", industry: "高端制造", score: 45, rating: "持有" as RatingLevel, priceChange: "+1.5%", signal: "自主供应链完善", lastUpdated: "2026-05-30 12:00" },
  { code: "300751", name: "迈为股份", industry: "高端制造/光伏设备", score: 58, rating: "持有" as RatingLevel, priceChange: "-3.8%", signal: "原材料价格稳定", lastUpdated: "2026-05-30 12:00" },
  { code: "603606", name: "东方电缆", industry: "高端制造/海缆", score: 52, rating: "持有" as RatingLevel, priceChange: "+3.5%", signal: "原材料价格稳定", lastUpdated: "2026-05-30 12:00" },
  { code: "688500", name: "博众精工", industry: "高端制造", score: 42, rating: "持有" as RatingLevel, priceChange: "-3.8%", signal: "自主供应链完善", lastUpdated: "2026-05-30 12:00" },
  { code: "688698", name: "伟创电气", industry: "高端制造/工控", score: 40, rating: "持有" as RatingLevel, priceChange: "-0.8%", signal: "自主供应链完善", lastUpdated: "2026-05-30 12:00" },
  { code: "002353", name: "杰瑞股份", industry: "高端装备", score: 32, rating: "增持" as RatingLevel, priceChange: "-5.2%", signal: "供应链状态正常", lastUpdated: "2026-05-30 12:00" },
  { code: "300818", name: "耐普矿机", industry: "高端装备", score: 35, rating: "增持" as RatingLevel, priceChange: "-5.2%", signal: "供应链状态正常", lastUpdated: "2026-05-30 12:00" },
  { code: "301160", name: "翔楼新材", industry: "新材料", score: 30, rating: "增持" as RatingLevel, priceChange: "+5.8%", signal: "供应链状态正常", lastUpdated: "2026-05-30 12:00" },
  { code: "003007", name: "直真科技", industry: "通信设备", score: 40, rating: "持有" as RatingLevel, priceChange: "+1.5%", signal: "供应链状态正常", lastUpdated: "2026-05-30 12:00" },
  // ─── 机器人/储能交叉 ───
  { code: "689009", name: "九号公司", industry: "机器人/储能", score: 38, rating: "增持" as RatingLevel, priceChange: "-1.2%", signal: "产能扩张中", lastUpdated: "2026-05-30 12:00" },
  { code: "002851", name: "麦格米特", industry: "机器人/储能", score: 48, rating: "持有" as RatingLevel, priceChange: "-1.2%", signal: "锂电材料价格波动", lastUpdated: "2026-05-30 12:00" },
  { code: "920978", name: "开特股份", industry: "机器人/汽车电子", score: 35, rating: "增持" as RatingLevel, priceChange: "+8.2%", signal: "减速器供应稳定", lastUpdated: "2026-05-30 12:00" },
  { code: "920839", name: "万通液压", industry: "机器人/减速器", score: 32, rating: "增持" as RatingLevel, priceChange: "-1.2%", signal: "减速器供应稳定", lastUpdated: "2026-05-30 12:00" },
  { code: "920242", name: "建邦科技", industry: "机器人", score: 30, rating: "增持" as RatingLevel, priceChange: "-5.2%", signal: "核心零部件国产化", lastUpdated: "2026-05-30 12:00" },
];
...
function generateScore(code: string): SupplyChainScore {
  ...
  if (ov >= 85) rating = "减持";
  else if (ov >= 70) rating = "减持";
  else if (ov >= 40) rating = "持有";
  else if (ov >= 20) rating = "增持";
  else rating = "强烈推荐";
...
const ratingHistory: Record<string, { date: string; rating: RatingLevel }[]> = {
  "688981": [
    { date: "2026-05", rating: "减持" },
    { date: "2026-04", rating: "减持" },
    { date: "2026-03", rating: "减持" },
    { date: "2026-02", rating: "持有" },
    { date: "2026-01", rating: "强烈推荐" },
  ],
  "300750": [
    { date: "2026-05", rating: "持有" },
    { date: "2026-04", rating: "增持" },
    { date: "2026-03", rating: "增持" },
    { date: "2026-02", rating: "持有" },
    { date: "2026-01", rating: "持有" },
  ],
  "688256": [
    { date: "2026-05", rating: "减持" },
    { date: "2026-04", rating: "减持" },
    { date: "2026-03", rating: "减持" },
    { date: "2026-02", rating: "减持" },
    { date: "2026-01", rating: "持有" },
  ],
};
...
const defaultHistory: { date: string; rating: RatingLevel }[] = [
  { date: "2026-05", rating: "持有" },
  { date: "2026-04", rating: "持有" },
  { date: "2026-03", rating: "增持" },
  { date: "2026-02", rating: "增持" },
  { date: "2026-01", rating: "强烈推荐" },
];
